    ...
    $.jqmCalendar = function(element, options) {
            ...
            plugin.settings.eventHandler.getImportanceOfDay(date,
                function(importance) {
                    if (importance.length > 0) {
                        $a.append("<span class=\"day-smileys\">");
                    }
                    for (var i = 0; i < importance.length; i++) {
                        $a.find(".day-smileys").append("<i class=\"ui-"+importance[i].icon+"\">&bull;</i>");
                    }
                    ...
                    if ( date.getFullYear() === today.getFullYear() &&
                        ...
                        $a.addClass("importance-" + importance.length);
                    }
                });
        }
        ...
        function listItemFormatter($listItem, timeString, summary, event) {
            ...
            if (event[plugin.settings.icon]) {
                ...
                $listItem.addClass('ui-'+event.icon);
            }
